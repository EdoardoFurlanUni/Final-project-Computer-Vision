...
\end{equation}
similarly, the local mean of the squared intensity values is computed as:
\begin{equation}
...
\end{equation}
After normalizing to the interval $[0,255]$, a threshold is applied to obtain a binary mask that highlights strong local variance values:
\begin{equation}
    M(x,y) = \begin{cases}
